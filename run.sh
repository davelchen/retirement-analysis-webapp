...
echo "  📍 Direct to Wizard: http://localhost:8501/Wizard"
echo "  📍 Direct to Analysis: http://localhost:8501/Monte_Carlo_Analysis"
echo ""
echo "Recommended Workflow:"
echo "  1. 🧙‍♂️ Start with Setup Wizard for parameter configuration"
echo "  2. 📊 Navigate to Monte Carlo Analysis to run simulations"
...
echo "   • Use the sidebar to switch between Wizard and Analysis"
echo "   • Bookmark specific pages for direct access"
